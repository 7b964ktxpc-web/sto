...
begin
  ...
  -- Serialize bookings for one business/day, then let the exclusion constraint
  -- provide the final resource-level concurrency guarantee.
  ...
  values (v_appointment_id,p_user_id,'BOOKING_CREATED',jsonb_build_object('source','marketplace'));
